        ...
        <section className='text-white pt-[22px] md:pt-[50px]' ref={ref} id='about'>
            ...
            <div className='mt-2 md:mt-0 md:grid md:grid-cols-2 gap-8 items-center py-8 xl:gap-16 sm:py-16 pb-0 xl:py-16'>
                ...
                <div className='mt-6 md:mt-0 text-left flex flex-col h-full'>
                    ...
                    >
                        I am a full stack web developer with a passion for creating interactive and responsice 
                        web applications. I have experience working with Javascript, React, Redux, Node.js, Flutter, Laravel,
                        HTML, CSS, and Git. I am a quick learner always lookin forward to expand my knowledge and skill set.
